...
const Home = () => {
	return (
		<div>
			...
			<div className="section  py-14">
				<div className="section w-4/6 m-auto ">
					<div className="flex justify-between">
						<h1 className="text-xl my-2">Nhà cấp 4</h1>
			...
			<div className="section p-14 w-4/6 m-auto flex justify-center gap-20 bg-slate-200">
				<div className="">
					<h1 className="text-5xl font-extrabold text-green-700">4000</h1>
					<h3 className="text-xl font-semibold text-slate-400">Lorem ipsum dolor sit </h3>
				</div>
				<div className="">
					<h1 className="text-5xl font-extrabold text-green-700">4000</h1>
					<h3 className="text-xl font-semibold text-slate-400">Lorem ipsum dolor sit </h3>
